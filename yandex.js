...
(function (win, doc, nav, params, namespace, undefined) {
    ...
    var initWidget = function () {
        util.loadScript('https://yastatic.net/s3/translate/v19.3.1/js/tr_page.js', wrapper, function () {
                ...
                function (responseText) {
                    ...
                    new Widget({
                        ...
                        translator: new namespace.PageTranslator({
                            srv: 'tr-url-widget',
                            sid: '074e0c5d.5c882ba0.66055fbb',
...
})(this, this.document, this.navigator, {"widgetTheme":"dark","pageLang":"en","autoMode":"true","widgetId":"ytWidget"}, this.yt = this.yt || {});